...
const ToggleAI: React.FC<ToggleAIProps> = ({
  ...
  return (
    <DropdownMenu>
        ...
        <Button
          ...
          className={cn(
            ...
            isEnabled
              ...
              : "bg-background/70 hover:bg-primary/10 text-foreground border-border hover:border-primary/50",
      ...
      <DropdownMenuContent align="end" className="w-72 border-border/80 bg-popover/95 backdrop-blur-xl">
