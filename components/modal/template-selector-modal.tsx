...
const TemplateSelectionModal = ({
  ...
  return (
    ...
    >
      <DialogContent className="forge-panel-strong max-h-[90vh] overflow-y-auto sm:max-w-[860px]">
        {step === "select" ? (
          <>
            <DialogHeader>
                        ...
                        key={template.id}
                          ...
                          ${
                            selectedTemplate === template.id
                              ? "border-primary/80 bg-primary/10 shadow-[0_0_0_1px_rgba(255,90,31,0.35),0_12px_35px_rgba(255,90,31,0.12)]"
                          ...
                          <div className="flex flex-col">
                            ...
                            <div className="flex flex-wrap gap-2 mt-auto">
                              {template.tags.map((tag) => (
                                <span
                                  key={tag}
                                  className="rounded-md border border-border/70 px-2 py-1 font-code text-xs text-muted-foreground"
                                >
                                  {tag}
                                </span>
                              ))}
          ...
          <>
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="rounded-lg border border-primary/40 bg-primary/10 p-4 shadow-[0_8px_30px_rgba(255,90,31,0.12)]">
